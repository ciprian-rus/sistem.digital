...
export const themes = {
  "light": {
    ...
    "roles": {
      ...
      "text.accent": "#a63e22",
      "text.inverse": "#ffffff",
      "text.disabled": "#647082",
      "surface.page": "#faf6ef",
      "surface.subtle": "#f3eee4",
      "surface.raised": "#fffdf9",
      "surface.strong": "#1e2a52",
      "border.default": "#ddd3c2",
      "border.strong": "#7d7264",
      "border.disabled": "#ddd3c2",
      "link.default": "#a63e22",
      "link.hover": "#7a2d19",
      "link.active": "#5c2112",
      "link.visited": "#6d28d9",
      "action.primary.background": "#c1502e",
      "action.primary.text": "#ffffff",
      "action.primary.hover": "#a63e22",
      "action.primary.active": "#8a331b",
...
export const themeMetadata = {
  ...
  "sourceHash": "bf1158c51f59429d38aa7598a946db41801caa42acd081131afff6514e5a29f7",
  "themeCount": 4,
  "accentCount": 4,
  "requiredRoleCount": 39,
  "contrastPairCount": 20
} as const;
