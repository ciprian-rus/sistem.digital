...
const familyDefinitions = {
  forms: {
    ...
    sourceHref: 'https://github.com/ciprian-rus/sistem.digital/blob/main/packages/components/src/forms.ts',
    names: [
      'label',
      'hint',
      'fieldset',
...
function markupFor(name) {
  const examples = {
    ...
    fieldset: '<fieldset class="sd-fieldset"><legend class="sd-legend">Cum vrei să primești răspunsul?</legend><label class="sd-choice"><input type="radio" name="delivery" checked> Digital</label></fieldset>',
    legend: '<fieldset class="sd-fieldset"><legend class="sd-legend">Alege o opțiune</legend><label class="sd-choice"><input type="checkbox"> Sunt de acord</label></fieldset>',
    input: '<label class="sd-label" for="catalog-email">Adresa de e-mail</label><input class="sd-input" id="catalog-email" type="email" autocomplete="email">',
    textarea: '<label class="sd-label" for="catalog-message">Mesaj</label><textarea class="sd-textarea" id="catalog-message" rows="4"></textarea>',
    select: '<label class="sd-label" for="catalog-county">Județ</label><select class="sd-select" id="catalog-county"><option>Cluj</option><option>Alba</option></select>',
    checkbox: '<label class="sd-choice"><input type="checkbox" checked> Doresc notificări electronice</label>',
    radio: '<fieldset class="sd-fieldset"><legend class="sd-legend">Format</legend><label class="sd-choice"><input type="radio" name="format" checked> Digital</label><label class="sd-choice"><input type="radio" name="format"> Hârtie</label></fieldset>',
    'error-message': '<p class="sd-error-message"><span class="sd-visually-hidden">Eroare:</span> Introdu o adresă de e-mail validă.</p>',
    'error-summary': '<section class="sd-error-summary" data-sd-error-summary tabindex="-1"><h2>Există o problemă</h2><ul><li><a href="#catalog-field">Introdu numele complet</a></li></ul></section>',
    button: '<button class="sd-button sd-button--primary" type="button">Continuă</button>',
    'button-group': '<div class="sd-button-group"><button class="sd-button sd-button--primary" type="button">Trimite cererea</button><a class="sd-link" href="#">Salvează și revino</a></div>',
    'file-upload': '<label class="sd-label" for="catalog-file">Document justificativ</label><input class="sd-file-upload" id="catalog-file" type="file">',
    'official-banner': '<section class="sd-official-banner" aria-label="Informație despre autenticitate"><div class="sd-official-banner__inner"><span class="sd-official-banner__mark" aria-hidden="true">RO</span><p>Domeniul oficial este <a href="#">institutie.ro</a>.</p></div></section>',
    'major-alert': '<section class="sd-major-alert" aria-labelledby="catalog-alert"><div class="sd-major-alert__inner"><span aria-hidden="true">!</span><div><strong id="catalog-alert">Serviciu indisponibil temporar</strong><p>Revenim la ora 14:00.</p></div></div></section>',
    'institution-header': '<header class="sd-header"><div class="sd-header__identity-row"><a class="sd-identity" href="#"><span class="sd-identity__mark" aria-hidden="true">SD</span><span class="sd-identity__text"><span class="sd-identity__name">Instituția exemplu</span><span class="sd-identity__service">Serviciu digital</span></span></a></div></header>',
    'desktop-navigation': '<nav class="sd-primary-navigation" aria-label="Navigație principală"><ul class="sd-primary-navigation__list"><li><a href="#" aria-current="page">Servicii</a></li><li><a href="#">Contact</a></li></ul></nav>',
    'mobile-navigation': '<details class="sd-mobile-navigation"><summary>Meniu</summary><nav aria-label="Navigație principală mobilă"><ul class="sd-mobile-navigation__list"><li><a href="#">Servicii</a></li><li><a href="#">Contact</a></li></ul></nav></details>',
    breadcrumb: '<nav class="sd-breadcrumb" aria-label="Breadcrumb"><ol class="sd-breadcrumb__list"><li class="sd-breadcrumb__item"><a href="#">Acasă</a></li><li class="sd-breadcrumb__item"><span aria-current="page">Cerere</span></li></ol></nav>',
    'service-navigation': '<nav class="sd-service-navigation" aria-label="În această secțiune"><h2 class="sd-service-navigation__title">În această secțiune</h2><ul class="sd-service-navigation__list"><li><a href="#" aria-current="page">Prezentare</a></li><li><a href="#">Eligibilitate</a></li></ul></nav>',
    search: '<form class="sd-search" role="search" action="#" method="get"><label class="sd-search__label" for="catalog-search">Caută</label><input class="sd-search__input" id="catalog-search" name="q" type="search"><button class="sd-search__button" type="submit">Caută</button></form>',
    footer: '<footer class="sd-footer"><div class="sd-footer__main"><section><h2 class="sd-footer__heading">Instituția exemplu</h2><p>Servicii digitale publice.</p></section><nav aria-label="Resurse"><ul class="sd-footer__list"><li><a href="#">Accesibilitate</a></li><li><a href="#">Contact</a></li></ul></nav></div></footer>',
    'skip-link': '<a class="sd-skip-link" href="#catalog-content">Sari la conținut</a><div id="catalog-content" tabindex="-1">Conținutul paginii</div>',
    link: '<a class="sd-link" href="#catalog-destination">Vezi condițiile de eligibilitate</a>',
    'external-link': '<a class="sd-link sd-link--external" href="https://example.org">Registrul extern<span class="sd-visually-hidden"> (site extern)</span></a>',
    alert: '<section class="sd-alert sd-alert--info" aria-labelledby="catalog-info"><span class="sd-alert__symbol" aria-hidden="true">i</span><div class="sd-alert__content"><strong class="sd-alert__title" id="catalog-info">Cererea poate fi salvată</strong><p>Poți reveni înainte de termen.</p></div></section>',
    'notification-banner': '<section class="sd-notification-banner sd-notification-banner--success" aria-labelledby="catalog-success"><span class="sd-notification-banner__symbol" aria-hidden="true">✓</span><div class="sd-notification-banner__content"><strong class="sd-notification-banner__title" id="catalog-success">Cererea a fost trimisă</strong><p>Număr de înregistrare: 12345.</p></div></section>',
    'inset-text': '<div class="sd-inset-text"><p><strong>Notă:</strong> instituția verifică informația direct la sursă.</p></div>',
    ...
    'responsive-table': '<div class="sd-table-container" role="region" aria-label="Cereri; tabel derulabil" tabindex="0"><table class="sd-table"><caption>Cereri înregistrate</caption><thead><tr><th scope="col">Instituție</th><th scope="col">Cereri</th></tr></thead><tbody><tr><th scope="row">Instituția A</th><td>1.248</td></tr></tbody></table></div>',
    'summary-list': '<dl class="sd-summary-list"><div class="sd-summary-list__row"><dt class="sd-summary-list__key">Cod fiscal</dt><dd class="sd-summary-list__value">12345678</dd></div></dl>',
    details: '<details class="sd-details"><summary>Ce documente sunt necesare?</summary><div class="sd-details__content"><p>Identitatea este verificată la sursă.</p></div></details>',
    pagination: '<nav class="sd-pagination" aria-label="Paginarea rezultatelor"><ul class="sd-pagination__list"><li><a href="#">Pagina anterioară</a></li><li><span aria-current="page">Pagina curentă, 2</span></li><li><a href="#">Pagina următoare</a></li></ul></nav>',
    metadata: '<ul class="sd-metadata" aria-label="Metadate"><li class="sd-metadata__item"><span class="sd-metadata__label">Sursă:</span> registru public</li><li class="sd-metadata__item"><span class="sd-metadata__label">Versiune:</span> 3</li></ul>',
    'last-updated': '<p class="sd-last-updated">Ultima actualizare: <time datetime="2026-07-23">23 iulie 2026</time></p>',
    accordion: '<div class="sd-accordion" data-sd-accordion="single"><details open><summary>Cine poate depune cererea?</summary><div class="sd-accordion__content"><p>Persoana vizată sau reprezentantul legal.</p></div></details><details><summary>Cât durează?</summary><div class="sd-accordion__content"><p>Două zile lucrătoare.</p></div></details></div>',
    dialog: '<a class="sd-button sd-button--primary" href="#catalog-dialog" aria-controls="catalog-dialog" data-sd-dialog-trigger>Revizuiește</a><dialog class="sd-dialog" id="catalog-dialog" data-sd-dialog aria-labelledby="catalog-dialog-title"><div class="sd-dialog__header"><h3 class="sd-dialog__title" id="catalog-dialog-title">Trimite cererea?</h3><button class="sd-dialog__close" type="button" data-sd-dialog-close>Închide</button></div><div class="sd-dialog__body"><p>Vei primi confirmarea în inbox.</p></div></dialog>',
...
const foundationItems = [
  {
    ...
    sourceHref:
      'https://github.com/ciprian-rus/sistem.digital/tree/main/packages/tokens/tokens',
    changelogHref:
      'https://github.com/ciprian-rus/sistem.digital/blob/main/packages/tokens/CHANGELOG.md',
    markup: '<div style="display:grid;gap:var(--sd-space-3);padding:var(--sd-space-5);background:var(--sd-color-surface-subtle);border:1px solid var(--sd-color-border);border-radius:var(--sd-radius-panel)"><strong>Suprafață semantică</strong><span>Valorile provin din design tokens.</span></div>',
  ...
  },
  {
    ...
    documentationHref: '/fundamente',
    sourceHref:
      'https://github.com/ciprian-rus/sistem.digital/tree/main/packages/tokens/themes',
    changelogHref:
      'https://github.com/ciprian-rus/sistem.digital/blob/main/packages/tokens/CHANGELOG.md',
    markup: '<div style="display:flex;gap:var(--sd-space-3);flex-wrap:wrap"><span class="sd-tag">Light</span><span class="sd-tag">Dark</span><span class="sd-tag">Contrast ridicat</span></div>',
  ...
  },
  {
    ...
    changelogHref:
      'https://github.com/ciprian-rus/sistem.digital/blob/main/packages/tokens/CHANGELOG.md',
    markup: '<div style="max-width:55ch"><h3 style="margin-top:0">Titlu fluid</h3><p>Măsura textului și spațierea folosesc rolurile structurale.</p></div>',
  ...
  },
  {
    ...
    description: 'Focus vizibil în trei straturi și animații care respectă preferințele sistemului.',
    packageName: '@sistem-digital/tokens',
    version: packageVersion,
    channel: 'alpha',
    status: 'alpha',
